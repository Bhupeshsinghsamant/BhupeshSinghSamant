...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=00E6FF&size=26&center=true&vCenter=true&width=750&lines=Designing+Intelligent+Systems;Building+Scalable+AI+Applications;Cloud+%26+Machine+Learning+Explorer;Engineering+Impact+Through+Code"/>
</p>
...
**MockMate** – AI-powered mock interview simulator  
**Path Finder** – BFS-based maze solving engine  
**Core Scheduler Simulator** – CPU scheduling visualization  
**Snap Cart** – Full-stack e-commerce platform  
**Helping Hands** – Fundraising management system  
